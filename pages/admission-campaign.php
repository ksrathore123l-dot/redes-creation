...
<head>
    ...
    <meta name="description" content="Digital Marketing & Admission Campaigns landing page for education brands." />
    <title>Digital Marketing & Admission Campaigns</title>
        ...
        <section class="ac-partner ac-section-pad">
            <div class="ac-container ac-partner-grid">
                ...
                <div class="ac-partner-copy ac-reveal ac-delay-1">
                    ...
                    <ul>
                        <li>Education-focused marketing expertise</li>
                        <li>Creative and result-driven campaigns</li>
                        <li>Dedicated support and strategy team</li>
                        <li>Proven success with schools, colleges and academies</li>
                    </ul>
                </div>
            </div>
        </section>
